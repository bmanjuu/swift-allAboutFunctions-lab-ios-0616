 ...
 */
// write your code here
let aCharacter = "Dwight Schrute"
favCharacter(aCharacter)

var anotherCharacter = "Phil Dunphy"
favCharacter(anotherCharacter)

anotherCharacter = "Donna Paulsen"
favCharacter(anotherCharacter)
 ...
 */
// write your code here
func favBand (number: Int, bandName: String) {
...
//need to insert "position" before Int argument
...
//needed to change the argument type for position from String to Int
...
madLib("Claire Dunphy", noun: "Gloria", preposition: "about")
 ...
 */
// write your code here
func buzzLightyearPhrase (characterName: String) -> String {
    return "To infinity and beyond, \(characterName.uppercaseString)!"
}

buzzLightyearPhrase("Elsa")
